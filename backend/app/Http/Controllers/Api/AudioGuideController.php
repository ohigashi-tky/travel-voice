...
class AudioGuideController extends Controller
{
    ...
    private function generateGenericSpotData(int $spotId): ?array
    {
        ...
        $detailedSpots = [
            ...
            503 => [
                'name' => '博多駅',
                'description' => '九州の玄関口として機能する巨大ターミナル駅。',
                'history' => '1889年に開業した博多駅は、九州の鉄道網の起点として発展してきました。2011年の九州新幹線全線開業に合わせて大規模な再開発が行われ、現在の姿になりました。',
                'episodes' => [
                    '博多駅の愛称「いっきゅうさん」は、駅番号JR19に因んで名付けられました。',
                    '駅ビル「JR博多シティ」は九州最大級の商業施設で、屋上には鉄道神社があります。',
                    '博多駅前の「博多町家」ふるさと館では、博多の伝統文化を体験できます。'
                ],
                'highlights' => ['新幹線', 'JR博多シティ', '博多阪急', '鉄道神社', '博多グルメ'],
                'cultural_significance' => '九州の交通・商業の中心地として、現代福岡の発展を象徴'
            ],
