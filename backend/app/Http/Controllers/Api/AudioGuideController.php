...
class AudioGuideController extends Controller
{
    ...
    private function getTouristSpotData(int $spotId): ?array
    {
        ...
        $spots = [
            ...
            801 => [
                ...
                'history' => '鎌倉時代の建長4年（1252年）頃に造立が開始されました。当初は大仏殿に安置されていましたが、室町時代の津波や地震により大仏殿が倒壊し、現在は露座の大仏として親しまれています。高さ13.35m、重量約121トンの青銅製で、日本で2番目に大きな大仏として知られています。',
                'episodes' => [
                    '大仏の内部は空洞になっており、胎内拝観が可能です。内部から見上げる大仏の造りは、当時の技術力の高さを物語っています。',
                    '大仏殿があった頃の礎石が現在も残っており、当時の壮大な建物の規模を想像することができます。',
                    '与謝野晶子の歌碑「かまくらやみほとけなれど釈迦牟尼は美男におはす夏木立かな」が境内にあります。'
                ],
                'highlights' => ['露座の大仏', '胎内拝観', '大仏殿跡の礎石', '観月堂', '与謝野晶子歌碑'],
                'cultural_significance' => '鎌倉時代の仏教文化と造仏技術の最高峰を示す重要文化財として、日本の仏教美術の象徴'
            ],
            802 => [
                'id' => 802,
                'name' => '箱根神社',
                'description' => '芦ノ湖畔に建つ湖上の鳥居で有名な神社。関東総鎮守として多くの参拝者が訪れます。',
                'history' => '天平宝字元年（757年）、万巻上人により創建された古社です。源頼朝が深く信仰し、鎌倉幕府の守護神として崇敬されました。江戸時代には東海道の要衝として多くの参拝者が訪れ、現在も関東総鎮守として親しまれています。',
                'episodes' => [
                    '芦ノ湖に立つ平和の鳥居は昭和27年に建立され、箱根のシンボルとして世界的に有名になりました。',
                    '源頼朝は箱根権現として深く信仰し、石橋山の戦いで敗れた際も箱根山中で匿われたと言われています。',
                    '九頭龍神社新宮では縁結びのご利益があるとされ、多くの参拝者が訪れます。'
                ],
                'highlights' => ['平和の鳥居', '九頭龍神社新宮', '宝物殿', '杉並木', '芦ノ湖の絶景'],
                'cultural_significance' => '古来からの山岳信仰と源氏の信仰を受け継ぐ、関東地方の重要な霊場'
            ],
            803 => [
                'id' => 803,
                'name' => '横浜中華街',
                'description' => '日本最大の中華街。約600店舗が軒を連ね、本格的な中華料理を楽しめる国際色豊かなエリアです。',
                'history' => '1859年の横浜港開港とともに中国人居留地として発展しました。当初は外国人居留地の一部でしたが、戦後の復興とともに現在の中華街として発展。1955年に中華街大通りが整備され、現在の賑わいの基礎が築かれました。約0.2平方キロメートルの区域内に約600店舗が軒を連ね、年間約2000万人が訪れる一大観光地です。',
                'episodes' => [
                    '関帝廟は商売繁盛の神様として中華街の人々に信仰され、三国志の英雄関羽を祀っています。',
                    '媽祖廟は航海安全の女神を祀り、華僑の人々の心の支えとなっています。',
                    '春節祭（旧正月）には獅子舞や龍舞のパレードが行われ、中華街が最も賑わう時期となります。'
                ],
                'highlights' => ['関帝廟', '媽祖廟', '本格中華料理', '春節祭', '中華街大通り'],
                'cultural_significance' => '日本における中華文化の拠点として、多文化共生の象徴的存在'
            ],
            804 => [
                'id' => 804,
                'name' => '江島神社',
                'description' => '江の島にある縁結びの神様として親しまれる神社。美しい海岸線と富士山の眺望も楽しめます。',
                'history' => '欽明天皇13年（552年）に勅命により島の洞窟（岩屋）に神様を祀ったのが始まりとされています。源頼朝が奥州平泉の藤原氏討伐を祈願し、また北条政子が安産祈願をしたなど、鎌倉時代から多くの武将に信仰されました。田寸津比賣命、市寸島比賣命、多紀理比賣命の三女神を祀り、恋愛成就・芸能上達のご利益があるとされています。',
                'episodes' => [
                    '江島神社のエスカーは日本初の屋外エスカレーターとして1959年に設置され、参拝の利便性を高めました。',
                    '龍恋の鐘は恋人同士で鐘を鳴らし、南京錠をかけると永遠の愛が約束されるという人気スポットです。',
                    '江の島展望灯台からは相模湾と富士山の絶景を一望でき、特に夕暮れ時の美しさは格別です。'
                ],
                'highlights' => ['縁結び', 'エスカー', '龍恋の鐘', '江の島展望灯台', '江島神社奉安殿'],
                'cultural_significance' => '江戸時代から続く江の島詣での聖地として、恋愛成就の象徴的な神社'
            ],
            805 => [
                'id' => 805,
                'name' => '赤レンガ倉庫',
                'description' => '明治・大正時代の歴史的建造物を活用した文化・商業施設。横浜港の美しい夜景スポットとしても人気です。',
                'history' => '明治40年（1907年）に2号館、大正2年（1913年）に1号館が竣工。横浜港の保税倉庫として約80年間使用されました。平成14年（2002年）に文化・商業施設として生まれ変わり、横浜の新しいシンボルとして多くの人々に愛されています。2号館には約50のショップとレストラン、1号館はイベントホールとして利用されています。',
                'episodes' => [
                    '赤レンガ倉庫は関東大震災や太平洋戦争の空襲にも耐え抜いた、堅牢な建造物です。',
                    '赤レンガパークでは年間を通して様々なイベントが開催され、特に冬のクリスマスマーケットは有名です。',
                    '夜景スポットとしても人気で、みなとみらいの高層ビル群とのコントラストが美しく映えます。'
                ],
                'highlights' => ['歴史的建造物', '赤レンガパーク', '夜景', 'イベント', 'みなとみらいの景観'],
                'cultural_significance' => '横浜港の歴史を物語る産業遺産として、現代に蘇った文化発信拠点'
            ],
            806 => [
                'id' => 806,
                'name' => '報国寺（竹寺）',
                'description' => '美しい竹林で有名な臨済宗の古刹。「竹の庭」では約2000本の孟宗竹が幻想的な空間を演出します。',
                'history' => '建武元年（1334年）に足利家時の祖父にあたる家義が開基となり、仏乗禅師を開山として創建されました。室町時代には足利氏の菩提寺として栄え、現在の竹林は江戸時代初期から植栽が始まったとされています。境内の竹林「竹の庭」には約2000本の孟宗竹が立ち並び、陽光が差し込む幻想的な美しさで多くの参拝者を魅了しています。',
                'episodes' => [
                    '竹の庭では抹茶を楽しみながら竹林の美しさを堪能できる茶席「休耕庵」があります。',
                    '足利氏の墓所があり、鎌倉幕府滅亡後の足利氏の歴史を物語る重要な史跡となっています。',
                    '竹林の小径を歩くと、竹の葉が風に揺れる音が心を癒やし、都市部では得られない静寂を体験できます。'
                ],
                'highlights' => ['竹の庭', '竹林', '茶席休耕庵', '足利氏の墓', '枯山水庭園'],
                'cultural_significance' => '鎌倉の禅文化と自然美が調和した、精神的安らぎを提供する古刹'
            ],
            ...
            201 => [
                ...
                'history' => '延暦17年（798年）、坂上田村麻呂によって建立されました。平安時代から「清水詣」として庶民に親しまれ、江戸時代には西国三十三箇所観音霊場の第16番札所として栄えました。現在の本堂は1633年に再建されたもので、釘を一本も使わない伝統的な日本建築の傑作です。',
                'episodes' => [
                ...
                'highlights' => ['清水の舞台', '音羽の滝', '地主神社', '三重塔', '桜と紅葉'],
    ...
    private function generateGenericSpotData(int $spotId): ?array
    {
        ...
        $detailedSpots = [
            ...
            // 神奈川県 (801-806) data is in main $spots array above
            
            // 千葉県 (900-999)
            901 => [
                'name' => '成田山新勝寺',
                'description' => '真言宗智山派の大本山。初詣の参拝者数は全国屈指で、成田のお不動さんとして親しまれています。',
                'history' => '天慶3年（940年）、平将門の乱を鎮めるため朱雀天皇の勅命により寛朝大僧正が東国へ下向し、不動明王の霊力により乱を平定後、この地に成田山新勝寺を開山しました。江戸時代には「成田詣」として庶民に親しまれ、現在も年間約1000万人の参拝者が訪れます。',
                'episodes' => [
                    '本尊の不動明王は弘法大師空海が一刀三礼をもって敬刻開眼された御尊像で、1000年以上にわたって護摩の火が絶えることなく燃え続けています。',
                    '江戸時代の歌舞伎役者や相撲取りが成田詣でを行ったことから、現在も多くの芸能人やスポーツ選手が参拝に訪れます。',
                    '成田山表参道は約800mの参道で、うなぎ料理店や土産物店が軒を連ね、参詣の楽しみを演出しています。'
                ],
                'highlights' => ['大本堂', '三重塔', '光明堂', '成田山公園', '表参道'],
                'cultural_significance' => '平将門の乱鎮定の歴史を持つ霊場として、関東地方の重要な信仰の中心地'
            ],
            902 => [
                'name' => '鴨川シーワールド',
                'description' => '海の世界との出会いをテーマにした水族館。シャチやイルカのパフォーマンスで有名な日本を代表する海洋公園です。',
                'history' => '1970年に開館した日本を代表する水族館です。800種11,000点の海の動物を飼育展示し、特にシャチのパフォーマンスは日本で唯一見ることができます。1998年には日本初のシャチの繁殖に成功し、海洋生物の研究・保護活動にも力を入れています。',
                'episodes' => [
                    'シャチパフォーマンスは1970年の開館と同時に始まり、現在まで50年以上続く伝統的なショーです。',
                    'イルカパフォーマンスでは、イルカの知能の高さと訓練師との絆の深さを感じることができます。',
                    'ベルーガ（白イルカ）の愛らしい表情と鳴き声は「海のカナリア」として多くの人を魅了しています。'
                ],
                'highlights' => ['シャチパフォーマンス', 'イルカパフォーマンス', 'ベルーガパフォーマンス', '笑うアシカ', 'トロピカルアイランド'],
                'cultural_significance' => '海洋生物の保護と教育を通じて海への理解を深める、日本の海洋教育の拠点'
            ],
            ...
            1001 => [
                ...
                'history' => '建武3年（1336年）、赤松貞範が姫山に築城したのが始まりです。その後、黒田官兵衛、池田輝政らにより拡張され、慶長14年（1609年）に現在の姿に完成しました。明治の廃城令でも取り壊されず、戦災も免れた奇跡の城として知られ、1993年に日本初の世界文化遺産に登録されました。',
                'episodes' => [
                    '白漆喰総塗籠造りの美しい外観から「白鷺城」と呼ばれ、その美しさは国内外で高く評価されています。',
                    '大天守は木造建築としては世界最高峰の技術で建てられ、400年以上経った今も当時の姿を保っています。',
                    '平成の大修理（2009-2015年）により、築城当時の美しい白さを取り戻しました。'
                ],
                'highlights' => ['大天守からの眺望', '西の丸からの天守群', '菱の門', '姫路城西御屋敷跡庭園好古園', '桜の名所'],
                'cultural_significance' => '日本の城郭建築の最高傑作として、世界に誇る文化遺産'
            ],
            1002 => [
                'name' => '有馬温泉',
                'description' => '日本三古湯の一つとして親しまれる歴史ある温泉地。金泉・銀泉の2つの泉質で多くの観光客を魅了しています。',
                'history' => '舒明天皇の時代（629年〜641年）に発見されたと伝えられ、奈良時代には行基により温泉寺が建立されました。平安時代には清少納言の「枕草子」にも記され、豊臣秀吉も愛した名湯として1400年の歴史を誇ります。現在も「日本三古湯」「日本三名泉」の一つとして親しまれています。',
                'episodes' => [
                    '豊臣秀吉は有馬温泉を特に愛し、9回も湯治に訪れました。現在も「太閤の湯」として秀吉ゆかりの施設があります。',
                    '金泉は鉄分とナトリウムを多く含む茶褐色の温泉で、銀泉は無色透明のラジウム泉です。',
                    '有馬玩具博物館では世界各国の玩具を展示し、温泉街の新たな魅力となっています。'
                ],
                'highlights' => ['金の湯', '銀の湯', '有馬玩具博物館', '温泉寺', '瑞宝寺公園'],
                'cultural_significance' => '日本最古の温泉地の一つとして、1400年の歴史と文化を今に伝える貴重な温泉郷'
            ],
            ...
            1101 => [
                ...
                'history' => '富士山は約10万年前から活動を始めた活火山で、現在の美しい形は約1万年前に形成されました。古代から山岳信仰の対象とされ、平安時代には富士山本宮浅間大社が創建され、江戸時代には富士講により庶民の信仰を集めました。2013年に「富士山-信仰の対象と芸術の源泉」として世界文化遺産に登録されました。',
                'episodes' => [
                    '富士山は日本人の心のふるさととして、古来より多くの和歌や俳句、浮世絵に描かれてきました。',
                    '葛飾北斎の「富嶽三十六景」は富士山の美しさを世界に紹介し、ジャポニスムの源流となりました。',
                    '富士講は江戸時代に民衆の間で広まった富士山信仰で、現在も富士山の文化的価値を支えています。'
                ],
                'highlights' => ['富士山本宮浅間大社', '富士五湖', '青木ヶ原樹海', '白糸の滝', '登山道'],
                'cultural_significance' => '日本人の精神的支柱として、信仰と芸術の源泉となってきた霊峰'
            ],
            1102 => [
                'name' => '熱海温泉',
                'description' => '古くから湯治場として栄えた日本有数の温泉リゾート。海と山に囲まれた美しい景観と豊富な湯量が自慢です。',
                'history' => '奈良時代に発見されたと伝えられ、鎌倉時代には源頼朝も訪れました。江戸時代には徳川家康が湯治に通い、明治時代以降は政財界人や文人墨客に愛される温泉地として発展しました。相模湾を望む美しい景観と、毎分約23,000リットルの豊富な湯量を誇ります。',
                'episodes' => [
                    '徳川家康は熱海温泉を特に愛し、江戸城まで温泉を運ばせたという記録があります。',
                    '明治時代以降、尾崎紅葉、夏目漱石、谷崎潤一郎など多くの文豪が熱海を訪れ、名作を生み出しました。',
                    '熱海梅園は日本で最も早咲きの梅として有名で、12月から3月まで長期間楽しめます。'
                ],
                'highlights' => ['熱海梅園', '來宮神社', '熱海城', 'MOA美術館', '相模湾の絶景'],
                'cultural_significance' => '徳川家康以来の由緒ある温泉地として、日本の温泉文化と文学文化の発展に貢献'
            ],
            ...
            // 愛媛県 spots moved to different IDs to avoid conflict with 神奈川県 (801-806)
        ...
        $basicSpotNames = [
            ...
            // 801-806 are 神奈川県 spots, mapped in main $spots array above
