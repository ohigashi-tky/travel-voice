export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      apiBase: process.env.NODE_ENV === 'development' ? 'http://localhost:8000' : process.env.NUXT_PUBLIC_API_BASE || 'https://travel-voice-production-61af.up.railway.app',
  ...
  pwa: {
    ...
    workbox: {
      ...
      runtimeCaching: [
        ...
        {
          urlPattern: /^https:\/\/travel-voice-production-61af\.up\.railway\.app\/api\/.*/i,
          handler: 'NetworkFirst',
          options: {
