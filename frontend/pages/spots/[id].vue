...
const allSpots = [
  ...
  },
  {
    ...
    prefecture: '神奈川県',
    imageUrl: '',
    overview: '横浜中華街は横浜市中区にある日本最大かつ東アジア最大の中華街です。約0.2平方キロメートルの区域内に約600店舗の中華料理店や雑貨店、食材店などが軒を連ね、年間約2000万人が訪れる一大観光地です。',
    highlights: ['関帝廟', '媽祖廟', '中華料理', '春節祭'],
    history: '1859年の横浜港開港とともに中国人居留地として発展しました。当初は外国人居留地の一部でしたが、戦後の復興とともに現在の中華街として発展。1955年に中華街大通りが整備され、現在の賑わいの基礎が築かれました。',
    images: [
      '',
      '',
      ''
  ...
  },
  {
    ...
    prefecture: '神奈川県',
    imageUrl: '',
    overview: '江島神社は江の島にある縁結びの神様として親しまれる神社です。田寸津比賣命、市寸島比賣命、多紀理比賣命の三女神を祀り、恋愛成就・芸能上達のご利益があるとされています。境内からは相模湾と富士山の美しい景色を望むことができます。',
    highlights: ['縁結び', 'エスカー', '龍恋の鐘', '江の島展望灯台'],
    history: '欽明天皇13年（552年）に勅命により島の洞窟（岩屋）に神様を祀ったのが始まりとされています。源頼朝が奥州平泉の藤原氏討伐を祈願し、また北条政子が安産祈願をしたなど、鎌倉時代から多くの武将に信仰されました。',
    images: [
      '',
      '',
      ''
  ...
  },
  {
    ...
    prefecture: '神奈川県',
    imageUrl: '',
    overview: '横浜赤レンガ倉庫は明治・大正時代に建設された歴史的建造物で、現在は文化・商業施設として活用されています。2号館には約50のショップとレストラン、1号館はイベントホールとして利用され、年間を通じて様々な催しが開催されています。',
    highlights: ['歴史的建造物', '赤レンガパーク', '夜景', 'イベント'],
    history: '明治40年（1907年）に2号館、大正2年（1913年）に1号館が竣工。横浜港の保税倉庫として約80年間使用されました。平成14年（2002年）に文化・商業施設として生まれ変わり、横浜の新しいシンボルとして多くの人々に愛されています。',
    images: [
      '',
      '',
      ''
  ...
  },
  {
    ...
    prefecture: '神奈川県',
    imageUrl: '',
    overview: '報国寺は鎌倉にある臨済宗建長寺派の寺院で、「竹寺」の愛称で親しまれています。境内の竹林「竹の庭」には約2000本の孟宗竹が立ち並び、陽光が差し込む幻想的な美しさで多くの参拝者を魅了しています。',
    highlights: ['竹の庭', '竹林', '茶席休耕庵', '足利氏の墓'],
    history: '建武元年（1334年）に足利家時の祖父にあたる家義が開基となり、仏乗禅師を開山として創建されました。室町時代には足利氏の菩提寺として栄え、現在の竹林は江戸時代初期から植栽が始まったとされています。',
    images: [
      '',
      '',
      ''
  ...
  // 千葉県の残りのスポット
  {
    id: 903,
    name: '東京ディズニーランド',
    description: '魔法の国をテーマにした世界最高峰のテーマパーク。夢と魔法の体験ができる日本を代表する観光地です。',
    category: 'テーマパーク',
    prefecture: '千葉県',
    imageUrl: '',
    overview: '東京ディズニーランドは1983年に開園した東京ディズニーリゾートの中核施設です。ディズニーの魔法の世界を再現した7つのテーマランドがあり、世界中から年間約1600万人のゲストが訪れます。',
    highlights: ['シンデレラ城', 'パレード', 'キャラクターグリーティング', 'アトラクション'],
    history: '1983年4月15日に東洋初のディズニーテーマパークとして開園。アメリカ国外では初のディズニーランドとして注目を集め、日本の観光業界に大きな影響を与えました。',
    images: ['', '', '']
  },
  // 兵庫県
  {
